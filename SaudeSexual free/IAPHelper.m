    ...
    for (SKPaymentTransaction * transaction in transactions) {
        switch (transaction.transactionState)
        {
            ...
            case SKPaymentTransactionStateRestored:
                NSLog(@"queue.transactions.count = %i",queue.transactions.count);
...
#pragma mark - paymentQueue:updatedTransactions: methods
...
- (void)provideContentForProductIdentifier:(NSString *)productIdentifier {
    ...
    if ([productIdentifier isEqualToString:@"org.drsolution.saudesexual.all"]) {
        [_productIdentifiers enumerateObjectsUsingBlock:^(NSString *str, BOOL *stop) {
